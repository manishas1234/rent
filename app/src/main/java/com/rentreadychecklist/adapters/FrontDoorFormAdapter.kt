...
class FrontDoorFormAdapter(private val context:Context,  private val frontDoorItemList: ArrayList<String>):RecyclerView.Adapter<FrontDoorFormAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.formItemText.text = frontDoorItemList[position]
